...
.. csv-table::
   ...
   $ec0, |float|, Strain at peak unconfined strength
   ...
   $type_reinf, |float|, Reinforcement exponent parameter

.. note::

   Concrete compressive strength must be specified as negative.

   Tension stress is set to zero for positive strain.
...
Zignago, D., Barbato, M., and Hu, D. "Constitutive Model of Concrete Simultaneously Confined by FRP and Steel for Finite-Element Analysis of FRP-Confined RC Columns."
